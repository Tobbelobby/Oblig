...
## Task 
    ...
    or in a file.
    The three processes can run, without any isolation, in the same device by using localhost. Note that this is the minimum you have to accomplish. Of course, your tech leads
